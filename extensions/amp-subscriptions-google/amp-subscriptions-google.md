...
Real Time Config allows the publisher to specify the sku or sku's for a subscribe button at page load time. This allows user specific offers, time limited offers etc.
